...
window.WA_PANEL_HTML = `<div class="dashboard" id="wa-dashboard">
  ...
  <div class="card slider-card">
    <div class="mode-toggle-group" style="display: flex; gap: 12px; padding: 10px 12px;">
      <button type="button" class="mode-btn active" id="fab-mode-blur" style="flex:1; padding: 8px; border-radius: 6px; background: var(--md-primary-dim); color: var(--md-primary); border: 1px solid var(--md-primary); cursor: pointer; font-size: 0.8rem; font-weight: 500; transition: all 0.2s;">Premium</button>
  ...
  <span>If scrolling feels laggy, switch to Lite mode.</span>
  </div>
